...
namespace Crystals
{
    public class Position
    {
        ...
        public static Position NextRandomPosition(double centerX, double centerY, double radius, double speed, Molecule molecule)
        {
            var alpha = 2 * Math.PI * random.NextDouble();
            var distance = (radius - 11) * random.NextDouble() + 10;
